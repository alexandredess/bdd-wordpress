...
--
-- Structure de la table `vj9e_state`
--

CREATE TABLE `vj9e_state` (
...
--
-- Déchargement des données de la table `vj9e_state`
--

INSERT INTO `vj9e_state` (`id_state`, `id_country`, `id_zone`, `name`, `iso_code`, `tax_behavior`, `active`) VALUES
(1, 21, 2, 'AA', 'AA', 0, 1),
(2, 21, 2, 'AE', 'AE', 0, 1),
(3, 21, 2, 'AP', 'AP', 0, 1),
