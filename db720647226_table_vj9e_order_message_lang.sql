...
--
-- Structure de la table `vj9e_order_message_lang`
--

CREATE TABLE `vj9e_order_message_lang` (
...
--
-- Déchargement des données de la table `vj9e_order_message_lang`
--

INSERT INTO `vj9e_order_message_lang` (`id_order_message`, `id_lang`, `name`, `message`) VALUES
