...
--
-- Structure de la table `vj9e_touchize_variables`
--

CREATE TABLE `vj9e_touchize_variables` (
...
--
-- Déchargement des données de la table `vj9e_touchize_variables`
--

INSERT INTO `vj9e_touchize_variables` (`id_variable`, `id_shop`, `id_shop_group`, `name`, `description`, `value`, `is_color`, `template`, `date_add`, `date_upd`) VALUES
